SELECT
i_process.process_id as "需要输入的过程编号",
i_process.process_name as "需要输入的过程名称",
CONCAT(i_input.input_operate, "-", i_f_c.file_category_name, "-", i_input.input_name) as "需要输入的过程输入",
...
ORDER BY i_process.process_id asc, i_input.input_name asc, i_input.input_operate desc, o_process.process_id asc, o_output.output_name asc, o_output.output_operate desc
